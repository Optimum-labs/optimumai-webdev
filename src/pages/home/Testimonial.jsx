...
import author01 from "../../assets/images/testimonials/author-01.jpg";
import author02 from "../../assets/images/testimonials/author-02.jpg";
import author03 from "../../assets/images/testimonials/author-03.jpg";
              ...
              <div className="swiper-slide">
                <div className="rounded-xl bg-white px-4 py-[30px] shadow-testimonial dark:bg-dark sm:px-[30px]">
                  ...
                  <Link to="#" className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 classBame="text-sm font-semibold text-dark dark:text-white">
                        Sabo Masties
                      </h3>
                      <p className="text-xs text-body-secondary">Founder @ Rolex</p>
                    </div>
