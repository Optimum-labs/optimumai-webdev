          ...
          <div className="w-full px-4">
            <div className="mx-auto mb-[60px] max-w-[510px] text-center">
              ...
              <h2 className="mb-3 text-3xl font-bold text-dark dark:text-white sm:text-4xl md:text-[40px] md:leading-[1.2]">
                OptimumAI Pricing Plans
              </h2>
              <p className="text-base text-body-color dark:text-dark-6">
                Explore our range of AI-powered pricing plans to suit your needs.
              </p>
            </div>
          </div>
        </div>
        <div className="-mx-4 flex flex-wrap justify-center">
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div className="relative z-10 mb-10 overflow-hidden rounded-xl bg-white px-8 py-10 shadow-pricing dark:bg-dark-2 sm:p-12 lg:px-6 lg:py-10 xl:p-14">
              ...
              <h2 className="mb-11 text-4xl font-semibold text-dark dark:text-white xl:text-[42px] xl:leading-[1.21]">
                ...
                <span className="-ml-1 -tracking-[2px]">0.00</span>
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div className="relative z-10 mb-10 overflow-hidden rounded-xl bg-white px-8 py-10 shadow-pricing dark:bg-dark-2 sm:p-12 lg:px-6 lg:py-10 xl:p-14">
              ...
              <h2 className="mb-11 text-4xl font-semibold text-dark dark:text-white xl:text-[42px] xl:leading-[1.21]">
                <span className="text-xl font-medium">$</span>
                <span className="-ml-1 -tracking-[2px]">40.00</span>
                <span className="text-base font-normal text-body-color dark:text-dark-6">
                  Per Month
                </span>
              </h2>
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div className="relative z-10 mb-10 overflow-hidden rounded-xl bg-white px-8 py-10 shadow-pricing dark:bg-dark-2 sm:p-12 lg:px-6 lg:py-10 xl:p-14">
              ...
              <h2 className="mb-11 text-4xl font-semibold text-dark dark:text-white xl:text-[42px] xl:leading-[1.21]">
                <span className="text-xl font-medium">$</span>
                <span className="-ml-1 -tracking-[2px]">80.00</span>
                <span className="text-base font-normal text-body-color dark:text-dark-6">
                  Per Month
                </span>
              </h2>
