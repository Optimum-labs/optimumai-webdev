...
const TeamMember = ({ name, role, socialIcons, img }) => {
  return (
    <div className="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
      <div className="group mb-8 rounded-xl bg-white px-5 pb-10 pt-12 shadow-testimonial dark:bg-dark dark:shadow-none">
        <div className="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
          <img src={img} alt={`${name}'s image`} className="h-[120px] w-[120px] rounded-full" />
          ...
          <svg width="45" height="53" viewBox="0 0 45 53" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Example: socialIcons[0] for the first social icon */}
          </span>
        </div>
        <div className="text-center">
          ...
          <div className="flex items-center justify-center gap-5">
            {socialIcons.map((icon, index) => (
              <a key={index} href="javascript:void(0)" className="text-dark-6 hover:text-primary">
                {icon}
              </a>
            ))}
          </div>
